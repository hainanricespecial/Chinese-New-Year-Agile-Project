            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        $modifiedDate = $_POST['date'];
                        $articleID = $_POST['articleID'];
                        $articleTitle = $_POST['articleTitle'];
                        $articleContentSanitized = htmlspecialchars($_POST['articleContentEdited']);

                        /* SQL command to insert edited data into database */
                        $updateCommand = mysqli_prepare($connection, "UPDATE articles 
                                          SET article_title = ?, 
                                          article_content = ?, 
                                          article_last_modified_date = ?
                                          WHERE article_id = ? ");
                        
                        $updateCommand->bind_param('sssi', $articleTitle, $articleContentSanitized, $modifiedDate, $articleID);
                        $execute = mysqli_stmt_execute($updateCommand);

        
                        if ($execute == true) 
                        {
                            echo "<h2> Your article has been edited successfully. </h2>";
