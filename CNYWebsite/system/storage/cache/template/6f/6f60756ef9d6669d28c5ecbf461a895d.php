...
class __TwigTemplate_b2bd1765011f97bb9cb9b6bc37a78e59 extends Template
{
    private $source;
    private $macros = [];
        ...
        ";
            ...
            <td class=\"text-end\">
              <form method=\"post\" data-oc-toggle=\"ajax\" data-oc-load=\"";
                ...
                echo "\" class=\"btn btn-primary\"><i class=\"fas fa-shopping-cart fa-fw\"></i></button>
                <button type=\"submit\" formaction=\"";
                // line 36
                echo ($context["remove"] ?? null);
                echo "\" data-bs-toggle=\"tooltip\" title=\"";
                echo ($context["button_remove"] ?? null);
                echo "\" class=\"btn btn-danger\"><i class=\"fas fa-times fa-fw\"></i></button>
              </form>
            </td>
          </tr>
        ";
...
";
    ...
    {
        return new Source("", "catalog/view/template/account/wishlist_list.twig", "C:\\xampp\\htdocs\\CMS_TEMPLATE\\CNYWebsite\\catalog\\view\\template\\account\\wishlist_list.twig");
    }
}
